...
export function Sidebar({
      ...
      <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Affiche le menu latéral sur mobile.</SheetDescription>
          </SheetHeader>
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex h-full w-full flex-col bg-sidebar shadow-lg/10 group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm/5"
          data-sidebar="sidebar"
