...
function Toasts({
  ...
  return (
    <Toast.Portal data-slot="toast-portal" {...portalProps}>
      <Toast.Viewport
        className={cn(
          "fixed z-60 mx-auto flex w-[calc(100%-var(--toast-inset)*2)] max-w-lg [--toast-inset:--spacing(4)] sm:[--toast-inset:--spacing(8)]",
        ...
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Root
              ...
              toast={toast}
            >
              <Toast.Content className="pointer-events-auto flex items-center justify-between gap-2.5 overflow-hidden px-5 py-4 text-base transition-opacity duration-250 data-behind:not-data-expanded:pointer-events-none data-behind:opacity-0 data-expanded:opacity-100">
